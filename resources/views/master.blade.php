...
<head>
    ...
    <title>Pemilihan Ketua Himpunan Jurusan Fakultas Ekonomi dan Bisnis UB 2021</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('depan.kandidat') }}">Kandidat Jurusan</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="text-center text-muted py-5">
        <small>Pemilihan Ketua Himpunan Jurusan Fakultas Ekonomi dan Bisnis UB 2021</small>
    </div>
