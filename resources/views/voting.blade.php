...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        @endforeach
                        ...
                        <button type="button" class="btn btn-danger btn-sm mt-3" data-toggle="modal" data-target="#hapus_pemilih_{{ $k->id }}">
                            <i class="fa fa-pencil"></i> ABSTAIN
                        </button>
</div>
...
<script type="text/javascript">
    ...
    // localStorage.setItem("end", null);
        ...
        if(confirm("TIME UP!"))
        window.location.href= `{{ route('depan.login.siswa.logout')  }}`;
    } else {
        var value = sec;
