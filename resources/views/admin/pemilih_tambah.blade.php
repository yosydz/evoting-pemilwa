...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
             ...
             <div>
                <h5>Data Pemilih</h5>
                <small class="text-muted">Tambah pemilih baru</small>
            </div>
            <hr>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('pemilih.aksi') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="form-group has-feedback">
                                ...
                                <input id="nim" type="number" placeholder="nim" class="form-control @error('nim') is-invalid @enderror" name="nim" value="{{ old('nim') }}" autocomplete="off">
